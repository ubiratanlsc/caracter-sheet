...
function App() {
  const [personagem, setPersonagem] = useState({
    ...
    habilidades: {
      for: 10, forPen: 0, forBon: 0, forMod: 0,
      des: 10, desPen: 0, desBon: 0, desMod: 0,
      con: 10, conPen: 0, conBon: 0, conMod: 0,
      int: 10, intPen: 0, intBon: 0, intMod: 0,
      sab: 10, sabPen: 0, sabBon: 0, sabMod: 0,
      car: 10, carPen: 0, carBon: 0, carMod: 0,
    }
  })
  return (
